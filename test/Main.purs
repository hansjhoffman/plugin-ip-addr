...
main = launchAff_ $ runSpec [ consoleReporter ] do
  ...
  describe "parse_" do
    it "should handle valid IPv4 addresses" do
      (fromRight dummyMsg $ toString_ <$> parse_ "127.0.0.1") `shouldEqual` "127.0.0.1"
      (fromRight dummyMsg $ toString_ <$> parse_ "0.0.0.0") `shouldEqual` "0.0.0.0"
      (fromRight dummyMsg $ toString_ <$> parse_ "255.255.255.255") `shouldEqual` "255.255.255.255"
